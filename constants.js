...
export { MAX_UNDO_STACK, MAX_POP_HISTORY, MAX_TRAIL_MAP, TRAIL_MAX_VALUE, TRAIL_PRUNE_THRESHOLD, MAX_CELL_IMPORT, MAX_FILE_SIZE, MAX_HL_COORD, HL_GC_THRESHOLD, STABLE_COUNT_THRESHOLD, GPS_DISPLAY_DURATION, LONG_PRESS_DELAY, MAX_STEP_COUNT, COLOR_STEPS, MAX_AGE, MAX_FLOOD_FILL, ANALYSIS_TIMEOUT, STATS_CHIP_REAPPEAR_DELAY, parseKey, RULE_PRESETS, SPEED_DELAYS, THEMES, detectAndParsePattern, overlayAges, SimEngine };
