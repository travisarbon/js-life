  ...
  function LifeBoard() {
    ...
    function renderMobileStatsBar() {
      ...
      return /*#__PURE__*/React.createElement("div", {
        ...
        className: "msb-title"
      }, "Conway's Game of Life"), 'Gen\u00a0' + state.generations.toLocaleString() + '\u2002Pop\u00a0' + population.toLocaleString() + trendArrow), /*#__PURE__*/React.createElement("span", {
    ...
    function renderCartographer(cs) {
      ...
      }, renderCanvas(cs, state, stateRef, refs, dispatch), /*#__PURE__*/React.createElement("div", {
        className: railClass,
        style: {
          width: railW + 'px'
        },
    ...
    function renderObservatory(cs) {
      ...
      return /*#__PURE__*/React.createElement("div", {
      ...
      }, renderCanvas(cs, state, stateRef, refs, dispatch), !zenMode && /*#__PURE__*/React.createElement("div", {
        ...
        return /*#__PURE__*/React.createElement("label", {
          ...
          onChange: function () {
            _togglePanelOpen(id, stateRef, refs, dispatch);
          },
          "aria-label": "Show " + label + " panel"
        }), /*#__PURE__*/React.createElement("span", null, label));
      })), renderLayoutSwitcher(state, stateRef, refs, dispatch))), renderMobileMinimapArea(state, stateRef, refs, dispatch));
    }
    ...
    function _renderFloatPanel(panelId, label, content) {
      ...
      }, isCompact ? _renderCompactBody(panelId, state, stateRef, refs, dispatch) : content), !ps.collapsed && /*#__PURE__*/React.createElement("div", {
    ...
    function _renderPanelGroup(group) {
      ...
      return /*#__PURE__*/React.createElement("div", {
        ...
        className: "float-panel-body"
      }, isCompact ? _renderCompactBody(activeTab, state, stateRef, refs, dispatch) : _getPanelContent(activeTab, state, stateRef, refs, dispatch)), /*#__PURE__*/React.createElement("div", {
        className: "float-panel-resize",
        onMouseDown: function (e) {
