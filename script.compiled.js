  ...
  (function () {
    var LifeBoard = React.createClass({
        ...
        if (isUnbounded) {
          ...
          if (pendingRows <= 0 || pendingCols <= 0) {
            return {
              w: Math.max(1, w),
              h: Math.max(1, h),
              displayW: Math.max(1, w),
              displayH: Math.max(1, h)
            };
          }
      ...
      panMinimapElement: function (e) {
        ...
        var mmCols = this.state.cols,
          mmRows = this.state.rows,
          mmOC = 0,
          mmOR = 0;
        if (this.state.boundary === 'unbounded') {
      ...
      renderSliders: function () {
        ...
        }, "Infinite grid \u2014 no dimension limits")), /*#__PURE__*/React.createElement("div", {
          className: "sliders"
        }, /*#__PURE__*/React.createElement("label", {
          className: "slider-title"
